...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function openCorner() {
    ...
    if (!demoLoaded) {
      ...
      fetch("../../../static/data/tale40.txt", { cache: "no-store" })
  ...
  function openGuide() {
    ...
    if (!guideLoaded) {
      ...
      fetch("../../../static/data/Summaries1-40/1-40summaries.json", { cache: "no-store" })
        ...
        .then(data => {
          guideLoaded = true;
          guideContent.innerHTML = generateGuideContent(data, "story_40");
        })
        .catch(err => {
  ...
  const IMG_BASES = [ "/static/images/Story_40/", "./static/images/Story_40/", "../static/images/Story_40/", "static/images/Story_40/" ];
