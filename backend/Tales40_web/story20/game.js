...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function openCorner() {
    ...
    if (!demoLoaded) {
      ...
      fetch("../../../static/data/tale20.txt", { cache: "no-store" })
  ...
  function openGuide() {
    ...
    if (!guideLoaded) {
      ...
      fetch("../../../static/data/Summaries1-40/1-40summaries.json", { cache: "no-store" })
        ...
        .then(data => {
          guideLoaded = true;
          guideContent.innerHTML = generateGuideContent(data, "story_20");
        })
        .catch(err => {
  ...
  /* =========================
     ...
     ========================= */
  const scenes = [
    { id: "read-letter",    file: "1.png", label: "อ่านจดหมายเชิญ" },
    { id: "catch-train",    file: "2.png", label: "รีบวิ่งขึ้นรถไฟ" },
    { id: "visit-relative", file: "3.png", label: "ไปบ้านญาติใต้ดอกป้อปปี้" },
    { id: "eat-outdoor",    file: "4.png", label: "กินข้าวข้างนอก" },
    { id: "eat-happy",      file: "5.png", label: "กินอาหารอย่างมีความสุข" },
    { id: "escape-cat",     file: "6.png", label: "หนีแมว" }
  ];
  const IMG_BASES = [ "/static/images/Story_20/", "./static/images/Story_20/", "../static/images/Story_20/", "static/images/Story_20/" ];
  ...
  droppableElements.forEach(box=>{
    ...
    box.addEventListener("drop", e=>{
      ...
      if(draggedId===expected){
        ...
        Swal.fire({icon:"error",title:"ผิดช่อง!",text:"มาลองใหม่อีกครั้งกัน!!",confirmButtonText:"ตกลง"});
      }
    });
  });
