...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function openCorner() {
    ...
    if (!demoLoaded) {
      ...
      fetch("../../../static/data/tale29.txt", { cache: "no-store" })
  ...
  function openGuide() {
    ...
    if (!guideLoaded) {
      ...
      fetch("../../../static/data/Summaries1-40/1-40summaries.json", { cache: "no-store" })
        ...
        .then(data => {
          guideLoaded = true;
          guideContent.innerHTML = generateGuideContent(data, "story_29");
        })
        .catch(err => {
  ...
  const IMG_BASES = [ "/static/images/Story_29/", "./static/images/Story_29/", "../static/images/Story_29/", "static/images/Story_29/" ];
