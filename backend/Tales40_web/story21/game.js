...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function startCountdown() {
    ...
    countdownInterval = setInterval(() => {
      ...
      if (countdown <= 0) {
        ...
        guideToggle.style.backgroundColor = "#211";  // เปลี่ยนสีปุ่มกลับเป็นปกติ
  ...
  function openCorner() {
    ...
    if (!demoLoaded) {
      ...
      fetch("../../../static/data/tale21.txt", { cache: "no-store" })
  ...
  function openGuide() {
    ...
    if (!guideLoaded) {
      ...
      fetch("../../../static/data/Summaries1-40/1-40summaries.json", { cache: "no-store" })
        ...
        .then(data => {
          guideLoaded = true;
          guideContent.innerHTML = generateGuideContent(data, "story_21");
        })
        .catch(err => {
  ...
  const IMG_BASES = [ "/static/images/Story_21/", "./static/images/Story_21/", "../static/images/Story_21/", "static/images/Story_21/" ];
