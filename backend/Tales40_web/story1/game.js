...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function openCorner() {
    ...
    if (!demoLoaded) {
      ...
      fetch("../../../static/data/tale01.txt", { cache: "no-store" })
  ...
  function openGuide() {
    ...
    if (!guideLoaded) {
      ...
      fetch("../../../static/data/Summaries1-40/1-40summaries.json", { cache: "no-store" })
        ...
        .then(data => {
          guideLoaded = true;
          guideContent.innerHTML = generateGuideContent(data, "story_01");
        })
        .catch(err => {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  musicToggleButton.addEventListener("click", () => {
    if (backgroundMusic.paused) {
      ...
      musicToggleButton.textContent = "🔊 เปิดเสียง"; // Update button text to "Mute"
    } else {
      backgroundMusic.pause();
      musicToggleButton.textContent = "🔇 ปิดเสียง"; // Update button text to "Play"
    }
  });
