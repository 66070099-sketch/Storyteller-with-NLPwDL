...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function openCorner() {
    ...
    if (!demoLoaded) {
      ...
      fetch("../../../static/data/tale03.txt", { cache: "no-store" })
  ...
  function openGuide() {
    ...
    if (!guideLoaded) {
      ...
      fetch("../../../static/data/Summaries1-40/1-40summaries.json", { cache: "no-store" })
        ...
        .then(data => {
          guideLoaded = true;
          guideContent.innerHTML = generateGuideContent(data, "story_03");
        })
        .catch(err => {
  ...
  const IMG_BASES = [ "/static/images/Story_3/", "./static/images/Story_3/", "../static/images/Story_3/", "static/images/Story_3/" ];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  musicToggleButton.addEventListener("click", () => {
    if (backgroundMusic.paused) {
      ...
      musicToggleButton.textContent = "🔇 ปิดเสียง"; // Update button text to "ปิดเสียง"
    } else {
