...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function startCountdown() {
    ...
    countdownInterval = setInterval(() => {
      ...
      if (countdown <= 0) {
        ...
        guideToggle.style.backgroundColor = "#221";  // เปลี่ยนสีปุ่มกลับเป็นปกติ
  ...
  function openCorner() {
    ...
    if (!demoLoaded) {
      ...
      fetch("../../../static/data/tale22.txt", { cache: "no-store" })
  ...
  function openGuide() {
    ...
    if (!guideLoaded) {
      ...
      fetch("../../../static/data/Summaries1-40/1-40summaries.json", { cache: "no-store" })
        ...
        .then(data => {
          guideLoaded = true;
          guideContent.innerHTML = generateGuideContent(data, "story_22");
        })
        .catch(err => {
  ...
  const IMG_BASES = [ "/static/images/Story_22/", "./static/images/Story_22/", "../static/images/Story_22/", "static/images/Story_22/" ];
